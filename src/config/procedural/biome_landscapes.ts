...
import { SpriteType } from './blocks_mappings.js'
import { BiomeType, BlockType, SpawnArea, SpawnConfHelper } from '@aresrpg/aresrpg-world'
...
const temperate = {
    ...
    LANDS: {
        ...
        spawn: SpawnConfHelper(
            new SpawnArea('villages', 0).addSparseSchematic('structures/sawmill', 1).addSparseSchematic('', 10),
            new SpawnArea('fields', 0.1)
                .addSpriteZone(SpriteType.FLOWER_PURPLE, 0)
                .addSpriteZone(SpriteType.GRASS_HIGH, 0.3)
                .addSpriteZone(SpriteType.FLOWER_PINK, 0.7),
