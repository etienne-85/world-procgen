import { chunksFromCompressedBlob, DataChunkStub } from '@aresrpg/aresrpg-world'

/**
 * WS client side
 */
export const chunksWsClient = (wsUrl: string, onChunkReceived: (chunkStub: DataChunkStub) => any) => {
